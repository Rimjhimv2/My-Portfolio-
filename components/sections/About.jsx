...
<p>Let's connect and collaborate to build something amazing together!</p>
</div>
  ...
  <div className="grid sm:grid-cols-2 gap-6">
    {certificatesData.map((cert, i) => (
      <a
        ...
        className="block"
      >
        <div className="glass-card hover-lift p-6 relative overflow-hidden group cursor-pointer">
